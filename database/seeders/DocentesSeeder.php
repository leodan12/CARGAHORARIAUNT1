...
class DocentesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('docentes')->insert(['nombres' => 'santos','apellidos' => 'fernandez','dni' => '32165487','condicion' => 'nombrado','categoria' => 'Asociado','modalidad' => 'tiempo completo','idUsuario' => '4','idEscuela' => '1',]);
