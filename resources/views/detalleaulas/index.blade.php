...
<div class="container-fluid ">
  <div class="form-group">
    ...
    <div class="container">
      <h3 class="text-center">LISTADO DE AULAS ASIGNADAS</h3>
    ...
    <nav class="navbar navbar-light ">
      <a href="{{route('detalleaula.create')}}" class="btn btn-success" style="border-radius: 40px;"><i class="fas fa-plus"></i>ASIGNAR AULAS A LAS CARGAS HORARIAS</a><br>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group" style="text-align: center">
                          <form class="submit-eliminar " action="{{action('DetalleaulaController@destroy', $k->id)}}" method="post">
                             @csrf
                             <input name="_method" type="hidden" value="DELETE">
                             <button onclick="return confirm('Desea cambiar el estado de la asignación de aula?')" style="border-radius: 40px;" type="submit" class="btn btn-danger btn-sm">
