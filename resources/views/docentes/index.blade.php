...
<div class="container-fluid ">
  <div class="form-group">
    ...
    <nav class="navbar navbar-light ">
      <a href="{{route('gestionardocentes.create')}}" class="btn btn-success" style="border-radius: 40px;"><i class="fas fa-plus"></i>REGISTRAR NUEVO DOCENTE</a><br>
     <form class="form-inline my-2 my-lg-0 float-right" method="GET">  <!--Para que se vaya a la derecha de la pagina float-->
      ...
      <div class="table-responsive"  style="border-radius: 12px;">
        ...
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col" style="text-align: center">ESCUELA</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group" style="text-align: center">
                          <form class="submit-eliminar " action="{{action('DocenteController@destroy', $k->id)}}" method="post">
                             @csrf
                             <input name="_method" type="hidden" value="DELETE">
                             <button onclick="return confirm('Desea cambiar el estado del docente?')" style="border-radius: 40px;" type="submit" class="btn btn-danger btn-sm">
      ...
      <div class="align-center" style="margin-left: 45%">{{$docente->links()}}</div>
</div>
