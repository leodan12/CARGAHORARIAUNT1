...
<div class="container-fluid ">
  <div class="form-group">
    ...
    <div class="container">
      <h3 class="text-center">LISTADO DE SEMESTRES</h3>
    ...
    <nav class="navbar navbar-light ">
      <a href="{{route('gestionarsemestres.create')}}" class="btn btn-success" style="border-radius: 40px;"><i class="fas fa-plus"></i>Registrar  Semestre</a><br>
     <form class="form-inline my-2 my-lg-0 float-right" method="GET">  <!--Para que se vaya a la derecha de la pagina float-->
            ...
            @foreach($semestre as $k)
                <tr>
                    ...
                    <td class="menu" data-animation="to-left">  
                      <a href="{{route('gestionarsemestres.edit',$k->id)}}"> 
                    ...
                    <td>
                      <div class="form-group" style="text-align: center">
                        <form class="submit-eliminar " action="{{action('SemestreController@destroy', $k->id)}}" method="post">
                           @csrf
      ...
      <div class="align-center" style="margin-left: 45%">{{$semestre->links()}} </div>
</div>
